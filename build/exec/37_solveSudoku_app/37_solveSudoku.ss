...
(define n--3258-1529-toRowHelper (lambda (v-0 v-1 v-2) (let ((sc0 v-2)) (case (get-tag sc0) ((0) (let ((v-3 (vector-ref sc0 1))) (vector 0 4294)))(else (List-Prelude-C-43C-43 4294 (vector 1 4294 (n--3266-1534-matToRow v-0 v-1 v-2 (List-Data-transpose 4294 (List-Data-take 4294 v-1 v-2))) (vector 0 4294)) (n--3258-1529-toRowHelper v-0 v-1 (List-Data-drop 4294 v-1 v-2))))))))
(define n--4007-2283-solveC-39 (lambda (v-0 v-1) (Main-case--4009-2287 v-0 v-1 (Main-isGridInvalid v-1))))
(define n--3015-1272-showCell (lambda (v-0) (let ((sc0 v-0)) (case (get-tag sc0) ((0) (let ((v-1 (vector-ref sc0 1))) (Prelude-show_Show__Int v-1)))(else ".")))))
(define n--3373-1657-replace2D (lambda (v-0 v-1 v-2 v-3) (Main-case--3378-1932 v-0 4294 v-3 v-2 (vector 0 4294 4294 (Prelude-div_Integral__Int v-2 ((Prelude-fromInteger_Num__Int) 9)) (Prelude-mod_Integral__Int v-2 ((Prelude-fromInteger_Num__Int) 9))))))
(define n--3378-1820-replace (lambda (v-0 v-1 v-2 v-3 v-4 v-5 v-6 v-7) (let ((v-8 (((List-Data-zip 4294 4294) v-7) (Prelude-take 4294 (Prelude-fromInteger_Num__Nat 100) (Prelude-rangeFrom_Range__C-36a 4294 (vector 0 4294 4294 (vector 0 4294 (vector 0 4294 (lambda (v-8) (lambda (v-9) (((Prelude-C-43_Num__Int) v-8) v-9))) (lambda (v-8) (lambda (v-9) (((Prelude-C-42_Num__Int) v-8) v-9))) (lambda (v-8) ((Prelude-fromInteger_Num__Int) v-8))) (lambda (v-8) (lambda (v-9) (Prelude-div_Integral__Int v-8 v-9))) (lambda (v-8) (lambda (v-9) (Prelude-mod_Integral__Int v-8 v-9)))) (vector 0 4294 4294 (vector 0 4294 (vector 0 4294 (lambda (v-8) (lambda (v-9) (Prelude-C-61C-61_Eq__Int v-8 v-9))) (lambda (v-8) (lambda (v-9) (Prelude-C-47C-61_Eq__Int v-8 v-9)))) (lambda (v-8) (lambda (v-9) (Prelude-compare_Ord__Int v-8 v-9))) (lambda (v-8) (lambda (v-9) (Prelude-C-60_Ord__Int v-8 v-9))) (lambda (v-8) (lambda (v-9) (Prelude-C-62_Ord__Int v-8 v-9))) (lambda (v-8) (lambda (v-9) (Prelude-C-60C-61_Ord__Int v-8 v-9))) (lambda (v-8) (lambda (v-9) (Prelude-C-62C-61_Ord__Int v-8 v-9))) (lambda (v-8) (lambda (v-9) (Prelude-max_Ord__Int v-8 v-9))) (lambda (v-8) (lambda (v-9) (Prelude-min_Ord__Int v-8 v-9)))) (vector 0 4294 (vector 0 4294 (lambda (v-8) (lambda (v-9) (((Prelude-C-43_Num__Int) v-8) v-9))) (lambda (v-8) (lambda (v-9) (((Prelude-C-42_Num__Int) v-8) v-9))) (lambda (v-8) ((Prelude-fromInteger_Num__Int) v-8))) (lambda (v-8) (Prelude-negate_Neg__Int v-8)) (lambda (v-8) (lambda (v-9) (((Prelude-C-45_Neg__Int) v-8) v-9)))))) ((Prelude-fromInteger_Num__Int) 0)))))) (Prelude-map_Functor__List 4294 4294 (lambda (v-9) (Main-case--3544-1864 v-0 4294 v-2 v-3 4294 v-7 v-6 v-5 v-8 v-9 (Prelude-C-61C-61_Eq__Int v-5 (Builtin-snd 4294 4294 v-9)))) v-8))))
(define n--2942-1206-readCell (lambda (v-0 v-1) (let ((sc0 v-1)) (cond ((equal? sc0 #\.) (vector 1 4294 (vector 1 (Prelude-rangeFromTo_Range__C-36a 4294 (vector 0 4294 4294 (vector 0 4294 (vector 0 4294 (lambda (v-2) (lambda (v-3) (((Prelude-C-43_Num__Int) v-2) v-3))) (lambda (v-2) (lambda (v-3) (((Prelude-C-42_Num__Int) v-2) v-3))) (lambda (v-2) ((Prelude-fromInteger_Num__Int) v-2))) (lambda (v-2) (lambda (v-3) (Prelude-div_Integral__Int v-2 v-3))) (lambda (v-2) (lambda (v-3) (Prelude-mod_Integral__Int v-2 v-3)))) (vector 0 4294 4294 (vector 0 4294 (vector 0 4294 (lambda (v-2) (lambda (v-3) (Prelude-C-61C-61_Eq__Int v-2 v-3))) (lambda (v-2) (lambda (v-3) (Prelude-C-47C-61_Eq__Int v-2 v-3)))) (lambda (v-2) (lambda (v-3) (Prelude-compare_Ord__Int v-2 v-3))) (lambda (v-2) (lambda (v-3) (Prelude-C-60_Ord__Int v-2 v-3))) (lambda (v-2) (lambda (v-3) (Prelude-C-62_Ord__Int v-2 v-3))) (lambda (v-2) (lambda (v-3) (Prelude-C-60C-61_Ord__Int v-2 v-3))) (lambda (v-2) (lambda (v-3) (Prelude-C-62C-61_Ord__Int v-2 v-3))) (lambda (v-2) (lambda (v-3) (Prelude-max_Ord__Int v-2 v-3))) (lambda (v-2) (lambda (v-3) (Prelude-min_Ord__Int v-2 v-3)))) (vector 0 4294 (vector 0 4294 (lambda (v-2) (lambda (v-3) (((Prelude-C-43_Num__Int) v-2) v-3))) (lambda (v-2) (lambda (v-3) (((Prelude-C-42_Num__Int) v-2) v-3))) (lambda (v-2) ((Prelude-fromInteger_Num__Int) v-2))) (lambda (v-2) (Prelude-negate_Neg__Int v-2)) (lambda (v-2) (lambda (v-3) (((Prelude-C-45_Neg__Int) v-2) v-3)))))) ((Prelude-fromInteger_Num__Int) 1) ((Prelude-fromInteger_Num__Int) 9)))))(else (Main-with--2954-1229 v-0 v-1 (Prelude-isDigit v-1)))))))
(define n--3155-1421-pruneCell (lambda (v-0 v-1) (let ((sc0 v-1)) (case (get-tag sc0) ((1) (let ((v-2 (vector-ref sc0 1))) (Main-case--3157-1452 v-0 v-2 (((Main-delete) v-2) (n--3157-1424-fixedsTmp v-0 v-2 v-0)))))(else (vector 1 4294 v-1))))))
(define n--3376-1705-possibilityCount (lambda (v-0 v-1 v-2 v-3 v-4) (let ((sc0 v-4)) (case (get-tag sc0) ((1) (let ((v-5 (vector-ref sc0 1))) (List-Data-length 4294 v-5))) ((0) (let ((v-5 (vector-ref sc0 1))) (Prelude-fromInteger_Num__Nat 1)))))))
(define n--3373-1655-minimumPossible (lambda (v-0 v-1) (let ((sc0 v-1)) (case (get-tag sc0) ((0) (let ((v-2 (vector-ref sc0 1))) (vector 0 4294 4294 ((Prelude-fromInteger_Num__Int) 0) (vector 1 (Prelude-take 4294 (Prelude-fromInteger_Num__Nat 10) (Prelude-rangeFrom_Range__C-36a 4294 (vector 0 4294 4294 (vector 0 4294 (vector 0 4294 (lambda (v-3) (lambda (v-4) (((Prelude-C-43_Num__Int) v-3) v-4))) (lambda (v-3) (lambda (v-4) (((Prelude-C-42_Num__Int) v-3) v-4))) (lambda (v-3) ((Prelude-fromInteger_Num__Int) v-3))) (lambda (v-3) (lambda (v-4) (Prelude-div_Integral__Int v-3 v-4))) (lambda (v-3) (lambda (v-4) (Prelude-mod_Integral__Int v-3 v-4)))) (vector 0 4294 4294 (vector 0 4294 (vector 0 4294 (lambda (v-3) (lambda (v-4) (Prelude-C-61C-61_Eq__Int v-3 v-4))) (lambda (v-3) (lambda (v-4) (Prelude-C-47C-61_Eq__Int v-3 v-4)))) (lambda (v-3) (lambda (v-4) (Prelude-compare_Ord__Int v-3 v-4))) (lambda (v-3) (lambda (v-4) (Prelude-C-60_Ord__Int v-3 v-4))) (lambda (v-3) (lambda (v-4) (Prelude-C-62_Ord__Int v-3 v-4))) (lambda (v-3) (lambda (v-4) (Prelude-C-60C-61_Ord__Int v-3 v-4))) (lambda (v-3) (lambda (v-4) (Prelude-C-62C-61_Ord__Int v-3 v-4))) (lambda (v-3) (lambda (v-4) (Prelude-max_Ord__Int v-3 v-4))) (lambda (v-3) (lambda (v-4) (Prelude-min_Ord__Int v-3 v-4)))) (vector 0 4294 (vector 0 4294 (lambda (v-3) (lambda (v-4) (((Prelude-C-43_Num__Int) v-3) v-4))) (lambda (v-3) (lambda (v-4) (((Prelude-C-42_Num__Int) v-3) v-4))) (lambda (v-3) ((Prelude-fromInteger_Num__Int) v-3))) (lambda (v-3) (Prelude-negate_Neg__Int v-3)) (lambda (v-3) (lambda (v-4) (((Prelude-C-45_Neg__Int) v-3) v-4)))))) ((Prelude-fromInteger_Num__Int) 1))))))) ((1) (let ((v-2 (vector-ref sc0 1))) (let ((v-3 (vector-ref sc0 2))) (let ((v-4 (vector-ref sc0 3))) (let ((sc1 v-4)) (case (get-tag sc1) ((0) (let ((v-5 (vector-ref sc1 1))) v-3)) ((1) (let ((v-5 (vector-ref sc1 1))) (let ((v-6 (vector-ref sc1 2))) (let ((v-7 (vector-ref sc1 3))) (Main-case--3376-1738 v-0 v-3 v-6 v-7 (Prelude-C-60C-61_Ord__Nat (n--3376-1705-possibilityCount v-0 v-3 v-6 v-7 (Builtin-snd 4294 4294 v-3)) (n--3376-1705-possibilityCount v-0 v-3 v-6 v-7 (Builtin-snd 4294 4294 v-6))))))))))))))))))
(define n--3266-1534-matToRow (lambda (v-0 v-1 v-2 v-3) (let ((sc0 v-3)) (case (get-tag sc0) ((0) (let ((v-4 (vector-ref sc0 1))) (vector 0 4294))) ((1) (let ((v-4 (vector-ref sc0 1))) (let ((v-5 (vector-ref sc0 2))) (let ((v-6 (vector-ref sc0 3))) (List-Prelude-C-43C-43 4294 v-5 (n--3266-1534-matToRow v-0 v-1 v-2 v-6))))))))))
(define n--3902-2180-isRowInvalid (lambda (v-0 v-1) (let ((v-2 (n--3904-2182-fixedsTmp v-0 v-1 v-1))) (let ((v-3 (List-Data-filter 4294 (lambda (v-3) (Prelude-C-38C-38 (Prelude-C-60_Ord__Int v-3 ((Prelude-fromInteger_Num__Int) 10)) (lambda () (Prelude-C-62_Ord__Int v-3 ((Prelude-fromInteger_Num__Int) 0))))) (n--3904-2182-fixedsTmp v-0 v-1 v-1)))) (Prelude-C-124C-124 ((Prelude-any 4294 4294 (vector 0 4294 (lambda (v-4) (lambda (v-5) (lambda (v-6) (lambda (v-7) (lambda (v-8) (Prelude-foldr_Foldable__List 4294 4294 v-6 v-7 v-8)))))) (lambda (v-4) (lambda (v-5) (lambda (v-6) (lambda (v-7) (lambda (v-8) (Prelude-foldl_Foldable__List 4294 4294 v-6 v-7 v-8))))))) (lambda (v-4) (Prelude-C-61C-61_Eq__Int v-4 ((Prelude-fromInteger_Num__Int) 0)))) v-2) (lambda () (Prelude-C-47C-61_Eq__Nat (List-Data-length 4294 v-3) (List-Data-length 4294 ((List-Data-nub 4294 (vector 0 4294 (lambda (v-4) (lambda (v-5) (Prelude-C-61C-61_Eq__Int v-4 v-5))) (lambda (v-4) (lambda (v-5) (Prelude-C-47C-61_Eq__Int v-4 v-5))))) v-3)))))))))
(define n--3373-1654-isPossible (lambda (v-0 v-1) (let ((sc0 v-1)) (case (get-tag sc0) ((1) (let ((v-2 (vector-ref sc0 1))) (vector 0 )))(else (vector 1 ))))))
(define n--3767-2045-isCellFilled (lambda (v-0 v-1) (let ((sc0 v-1)) (case (get-tag sc0) ((0) (let ((v-2 (vector-ref sc0 1))) (vector 0 ))) ((1) (let ((v-2 (vector-ref sc0 1))) (vector 1 )))))))
(define n--3904-2182-fixedsTmp (lambda (v-0 v-1 v-2) (let ((sc0 v-2)) (case (get-tag sc0) ((0) (let ((v-3 (vector-ref sc0 1))) (vector 0 4294))) ((1) (let ((v-3 (vector-ref sc0 1))) (let ((v-4 (vector-ref sc0 2))) (let ((v-5 (vector-ref sc0 3))) (Main-case--3906-2192 v-0 v-1 v-4 v-5)))))))))
(define n--3157-1424-fixedsTmp (lambda (v-0 v-1 v-2) (let ((sc0 v-2)) (case (get-tag sc0) ((0) (let ((v-3 (vector-ref sc0 1))) (vector 0 4294))) ((1) (let ((v-3 (vector-ref sc0 1))) (let ((v-4 (vector-ref sc0 2))) (let ((v-5 (vector-ref sc0 3))) (Main-case--3160-1434 v-0 v-1 v-4 v-5)))))))))
(define n--3334-1609-fixM (lambda (v-0 v-1) (Prelude-C-62C-62C-61_Monad__Maybe 4294 4294 (v-0 v-1) (lambda (v-2) (Main-case--3335-1631 v-1 v-0 v-2 (Prelude-C-61C-61_Eq__C-40ListC-32C-36aC-41 4294 (vector 0 4294 (lambda (v-3) (lambda (v-4) (Prelude-C-61C-61_Eq__C-40ListC-32C-36aC-41 4294 (vector 0 4294 (lambda (v-5) (lambda (v-6) (Main-C-61C-61_Eq__Cell v-5 v-6))) (lambda (v-5) (lambda (v-6) (Main-C-47C-61_Eq__Cell v-5 v-6)))) v-3 v-4))) (lambda (v-3) (lambda (v-4) (Prelude-C-47C-61_Eq__C-40ListC-32C-36aC-41 4294 (vector 0 4294 (lambda (v-5) (lambda (v-6) (Main-C-61C-61_Eq__Cell v-5 v-6))) (lambda (v-5) (lambda (v-6) (Main-C-47C-61_Eq__Cell v-5 v-6)))) v-3 v-4)))) v-2 v-1))))))
(define n--3373-1656-fixCell (lambda (v-0 v-1) (let ((sc0 v-1)) (case (get-tag sc0) ((0) (let ((v-2 (vector-ref sc0 1))) (let ((v-3 (vector-ref sc0 2))) (let ((v-4 (vector-ref sc0 3))) (let ((v-5 (vector-ref sc0 4))) (let ((sc1 v-5)) (case (get-tag sc1) ((1) (let ((v-6 (vector-ref sc1 1))) (let ((sc2 v-6)) (case (get-tag sc2) ((1) (let ((v-7 (vector-ref sc2 1))) (let ((v-8 (vector-ref sc2 2))) (let ((v-9 (vector-ref sc2 3))) (let ((sc3 v-9)) (case (get-tag sc3) ((1) (let ((v-10 (vector-ref sc3 1))) (let ((v-11 (vector-ref sc3 2))) (let ((v-12 (vector-ref sc3 3))) (let ((sc4 v-12)) (case (get-tag sc4) ((0) (let ((v-13 (vector-ref sc4 1))) (vector 0 4294 4294 v-4 (vector 0 4294 4294 (vector 0 v-8) (vector 0 v-11)))))(else (vector 0 4294 4294 v-4 (vector 0 4294 4294 (vector 0 v-8) (vector 1 v-9))))))))))(else (vector 0 4294 4294 v-4 (vector 0 4294 4294 (vector 0 v-8) (vector 1 v-9)))))))))))))) ((0) (let ((v-6 (vector-ref sc1 1))) (vector 0 4294 4294 v-4 (vector 0 4294 4294 (vector 0 v-6) (vector 0 v-6))))))))))))))))
(define n--3110-1373-deleteby (lambda (v-0 v-1) (let ((sc0 v-1)) (case (get-tag sc0) ((0) (let ((v-2 (vector-ref sc0 1))) (vector 0 4294))) ((1) (let ((v-2 (vector-ref sc0 1))) (let ((v-3 (vector-ref sc0 2))) (let ((v-4 (vector-ref sc0 3))) (Main-case--3111-1390 v-3 v-4 v-0 (Prelude-C-61C-61_Eq__Int v-0 v-3))))))))))
(define Main-with--2954-1229 (lambda (v-0 v-1 v-2) (let ((sc0 v-2)) (case (get-tag sc0) ((0) (vector 1 4294 (vector 0 (((Prelude-C-45_Neg__Int) ((Prelude-cast_Cast__Char_Int) v-1)) ((Prelude-cast_Cast__Char_Int) #\0))))) ((1) (vector 0 4294))))))
(define Main-with--2933-1195 (lambda (v-0 v-1) (let ((sc0 v-1)) (case (get-tag sc0) ((1) (vector 0 4294)) ((0) (Prelude-traverse_Traversable__List 4294 4294 4294 (vector 0 4294 (vector 0 4294 (lambda (v-2) (lambda (v-3) (lambda (v-4) (lambda (v-5) (Prelude-map_Functor__Maybe 4294 4294 v-4 v-5)))))) (lambda (v-2) (lambda (v-3) ((Prelude-pure_Applicative__Maybe 4294) v-3))) (lambda (v-2) (lambda (v-3) (lambda (v-4) (lambda (v-5) (Prelude-C-60C-42C-62_Applicative__Maybe 4294 4294 v-4 v-5)))))) (lambda (v-2) (Prelude-traverse_Traversable__List 4294 4294 4294 (vector 0 4294 (vector 0 4294 (lambda (v-3) (lambda (v-4) (lambda (v-5) (lambda (v-6) (Prelude-map_Functor__Maybe 4294 4294 v-5 v-6)))))) (lambda (v-3) (lambda (v-4) ((Prelude-pure_Applicative__Maybe 4294) v-4))) (lambda (v-3) (lambda (v-4) (lambda (v-5) (lambda (v-6) (Prelude-C-60C-42C-62_Applicative__Maybe 4294 4294 v-5 v-6)))))) (lambda (v-3) (n--2942-1206-readCell v-0 v-3)) v-2)) (Prelude-map_Functor__List 4294 4294 (lambda (v-2) (Prelude-unpack v-2)) (Main-chunksOfStr (Prelude-fromInteger_Num__Nat 9) v-0))))))))
(define Main-case--4086-2376 (lambda (v-0 v-1 v-2 v-3) (let ((sc0 v-3)) (case (get-tag sc0) ((0) (let ((v-4 (vector-ref sc0 1))) (PrimIO-putStrLn "No solution found"))) ((1) (let ((v-4 (vector-ref sc0 1))) (let ((v-5 (vector-ref sc0 2))) (PrimIO-putStrLn ((Main-showGrid) v-5)))))))))
(define Main-case--4071-2359 (lambda (v-0 v-1 v-2) (let ((sc0 v-2)) (case (get-tag sc0) ((0) (let ((v-3 (vector-ref sc0 1))) (PrimIO-putStrLn "Invalid input"))) ((1) (let ((v-3 (vector-ref sc0 1))) (let ((v-4 (vector-ref sc0 2))) (Main-case--4086-2376 v-0 v-1 v-4 (Main-solve v-4)))))))))
(define Main-case--4027-2317 (lambda (v-0 v-1 v-2) (let ((sc0 v-2)) (case (get-tag sc0) ((0) (let ((v-3 (vector-ref sc0 1))) (let ((v-4 (vector-ref sc0 2))) (let ((v-5 (vector-ref sc0 3))) (let ((v-6 (vector-ref sc0 4))) (Prelude-C-60C-124C-62_Alternative__Maybe 4294 (Main-solve v-5) (Main-solve v-6)))))))))))
(define Main-case--4012-2301 (lambda (v-0 v-1 v-2) (let ((sc0 v-2)) (case (get-tag sc0) ((0) (vector 1 4294 v-1)) ((1) (Main-case--4027-2317 v-0 v-1 (Main-nextGrids v-1)))))))
(define Main-case--4009-2287 (lambda (v-0 v-1 v-2) (let ((sc0 v-2)) (case (get-tag sc0) ((0) (vector 0 4294)) ((1) (Main-case--4012-2301 v-0 v-1 (Main-isGridFilled v-1)))))))
(define Main-case--3906-2192 (lambda (v-0 v-1 v-2 v-3) (let ((sc0 v-2)) (case (get-tag sc0) ((0) (let ((v-4 (vector-ref sc0 1))) (vector 1 4294 v-4 (n--3904-2182-fixedsTmp v-0 v-1 v-3)))) ((1) (let ((v-4 (vector-ref sc0 1))) (let ((sc1 v-4)) (case (get-tag sc1) ((0) (let ((v-5 (vector-ref sc1 1))) (vector 1 4294 (let ((sc2 (let ((v-6 (vector 1 (vector 0 4294)))) (vector 0 4294 (lambda (v-7) (lambda (v-8) (((Prelude-C-43_Num__Int) v-7) v-8))) (lambda (v-7) (lambda (v-8) (((Prelude-C-42_Num__Int) v-7) v-8))) (lambda (v-7) ((Prelude-fromInteger_Num__Int) v-7)))))) (case (get-tag sc2) ((0) (let ((v-6 (vector-ref sc2 1))) (let ((v-7 (vector-ref sc2 2))) (let ((v-8 (vector-ref sc2 3))) (let ((v-9 (vector-ref sc2 4))) (v-9 0)))))))) (n--3904-2182-fixedsTmp v-0 v-1 v-3))))(else (vector 1 4294 (let ((sc1 (let ((v-5 (vector 1 v-4))) (vector 0 4294 (lambda (v-6) (lambda (v-7) (((Prelude-C-43_Num__Int) v-6) v-7))) (lambda (v-6) (lambda (v-7) (((Prelude-C-42_Num__Int) v-6) v-7))) (lambda (v-6) ((Prelude-fromInteger_Num__Int) v-6)))))) (case (get-tag sc1) ((0) (let ((v-5 (vector-ref sc1 1))) (let ((v-6 (vector-ref sc1 2))) (let ((v-7 (vector-ref sc1 3))) (let ((v-8 (vector-ref sc1 4))) (v-8 10)))))))) (n--3904-2182-fixedsTmp v-0 v-1 v-3)))))))))))
(define Main-case--3373-2022 (lambda (v-0 v-1) (let ((sc0 v-1)) (case (get-tag sc0) ((0) (let ((v-2 (vector-ref sc0 1))) (let ((v-3 (vector-ref sc0 2))) (let ((v-4 (vector-ref sc0 3))) (let ((v-5 (vector-ref sc0 4))) (let ((sc1 v-5)) (case (get-tag sc1) ((0) (let ((v-6 (vector-ref sc1 1))) (let ((v-7 (vector-ref sc1 2))) (let ((v-8 (vector-ref sc1 3))) (let ((v-9 (vector-ref sc1 4))) (let ((sc2 v-8)) (case (get-tag sc2) ((0) (let ((v-10 (vector-ref sc2 1))) (vector 0 4294 4294 ((n--3373-1657-replace2D v-0 4294 v-4 v-8) v-0) ((n--3373-1657-replace2D v-0 4294 v-4 v-9) v-0))))))))))))))))))))))
(define Main-case--3378-1932 (lambda (v-0 v-1 v-2 v-3 v-4) (let ((sc0 v-4)) (case (get-tag sc0) ((0) (let ((v-5 (vector-ref sc0 1))) (let ((v-6 (vector-ref sc0 2))) (let ((v-7 (vector-ref sc0 3))) (let ((v-8 (vector-ref sc0 4))) (lambda (v-9) (n--3378-1820-replace v-0 4294 v-2 v-3 4294 v-7 (lambda (v-10) (n--3378-1820-replace v-0 4294 v-2 v-3 4294 v-8 (lambda (v-11) v-2) v-10)) v-9)))))))))))
(define Main-case--3544-1864 (lambda (v-0 v-1 v-2 v-3 v-4 v-5 v-6 v-7 v-8 v-9 v-10) (let ((sc0 v-10)) (case (get-tag sc0) ((0) (v-6 (Builtin-fst 4294 4294 v-9))) ((1) (Builtin-fst 4294 4294 v-9))))))
(define Main-case--3376-1738 (lambda (v-0 v-1 v-2 v-3 v-4) (let ((sc0 v-4)) (case (get-tag sc0) ((0) (n--3373-1655-minimumPossible v-0 (vector 1 4294 v-1 v-3))) ((1) (n--3373-1655-minimumPossible v-0 (vector 1 4294 v-2 v-3)))))))
(define Main-case--3335-1631 (lambda (v-0 v-1 v-2 v-3) (let ((sc0 v-3)) (case (get-tag sc0) ((0) (vector 1 4294 v-0)) ((1) (n--3334-1609-fixM v-1 v-2))))))
(define Main-case--3157-1452 (lambda (v-0 v-1 v-2) (let ((sc0 v-2)) (case (get-tag sc0) ((0) (let ((v-3 (vector-ref sc0 1))) (vector 0 4294))) ((1) (let ((v-3 (vector-ref sc0 1))) (let ((v-4 (vector-ref sc0 2))) (let ((v-5 (vector-ref sc0 3))) (let ((sc1 v-5)) (case (get-tag sc1) ((0) (let ((v-6 (vector-ref sc1 1))) (vector 1 4294 (vector 0 v-4))))(else (vector 1 4294 (vector 1 v-2)))))))))(else (vector 1 4294 (vector 1 v-2)))))))
(define Main-case--3160-1434 (lambda (v-0 v-1 v-2 v-3) (let ((sc0 v-2)) (case (get-tag sc0) ((0) (let ((v-4 (vector-ref sc0 1))) (vector 1 4294 v-4 (n--3157-1424-fixedsTmp v-0 v-1 v-3)))) ((1) (let ((v-4 (vector-ref sc0 1))) (n--3157-1424-fixedsTmp v-0 v-1 v-3)))))))
(define Main-case--3111-1390 (lambda (v-0 v-1 v-2 v-3) (let ((sc0 v-3)) (case (get-tag sc0) ((0) v-1) ((1) (vector 1 4294 v-0 (n--3110-1373-deleteby v-2 v-1)))))))
...
(define Main-a-2334 (lambda () (lambda (v-0) (vector 109 (vector 109 (vector 100 ))))))
(define Main-b-2333 (lambda () (lambda (v-0) (vector 109 (vector 109 (vector 100 ))))))
(define Main-a-2327 (lambda () (lambda (v-0) (lambda (v-1) (lambda (v-2) (lambda (v-3) (vector 109 (vector 109 (vector 100 )))))))))
(define Main-ty-2307 (lambda () (lambda (v-0) (lambda (v-1) (vector 109 (vector 109 (vector 100 )))))))
(define Main-ty-2293 (lambda () (lambda (v-0) (lambda (v-1) (vector 109 (vector 109 (vector 100 )))))))
(define Main-a-2264 (lambda () (lambda (v-0) (vector 109 (vector 100 )))))
(define Main-_-2224 (lambda () (lambda (v-0) (lambda (v-1) (lambda (v-2) (vector 109 (vector 3 )))))))
(define Main-_-2223 (lambda () (lambda (v-0) (lambda (v-1) (vector 109 (vector 3 ))))))
(define Main-sa-2063 (lambda () (lambda (v-0) (vector 107 ((Main-a-2058) v-0)))))
(define Main-sa-2062 (lambda () (lambda (v-0) (vector 111 (lambda (v-1) (vector 109 v-1))))))
(define Main-a-2058 (lambda () (lambda (v-0) (((Main-t-2054) v-0) (vector 100 )))))
(define Main-t-2054 (lambda () (lambda (v-0) (lambda (v-1) (vector 109 v-1)))))
(define Main-b-2037 (lambda () (lambda (v-0) (lambda (v-1) (lambda (v-2) (lambda (v-3) (vector 109 (vector 109 (vector 100 )))))))))
(define Main-a-2036 (lambda () (lambda (v-0) (lambda (v-1) (lambda (v-2) (lambda (v-3) (vector 109 (vector 109 (vector 100 )))))))))
(define Main-sa-2013 (lambda () (lambda (v-0) (vector 105 (vector 3 )))))
(define Main-sa-2012 (lambda () (lambda (v-0) (vector 104 (vector 3 )))))
(define Main-sa-2009 (lambda () (lambda (v-0) (vector 116 (vector 104 (vector 3 )) (vector 105 (vector 3 ))))))
(define Main-sa-2008 (lambda () (lambda (v-0) (vector 110 (vector 3 )))))
(define Main-a-1997 (lambda () (lambda (v-0) (vector 116 ((Main-a-1972) v-0) (vector 100 )))))
(define Main-sa-1993 (lambda () (lambda (v-0) (vector 107 ((Main-a-1985) v-0)))))
(define Main-sa-1992 (lambda () (lambda (v-0) (vector 111 (lambda (v-1) (vector 109 v-1))))))
(define Main-t-1986 (lambda () (lambda (v-0) (lambda (v-1) (vector 109 v-1)))))
(define Main-a-1985 (lambda () (lambda (v-0) (vector 109 ((Main-b-1971) v-0)))))
(define Main-a-1972 (lambda () (lambda (v-0) (vector 3 ))))
(define Main-b-1971 (lambda () (lambda (v-0) (vector 100 ))))
(define Main-b-1970 (lambda () (lambda (v-0) (vector 109 ((Main-b-1971) v-0)))))
(define Main-c-1969 (lambda () (lambda (v-0) (vector 109 (vector 116 ((Main-a-1972) v-0) ((Main-b-1971) v-0))))))
(define Main-b-1966 (lambda () (lambda (v-0) (vector 109 (vector 116 ((Main-a-1972) v-0) ((Main-b-1971) v-0))))))
(define Main-c-1965 (lambda () (lambda (v-0) (vector 109 (vector 116 (vector 3 ) (vector 100 ))))))
(define Main-a-1964 (lambda () (lambda (v-0) (((Main-t-1986) v-0) ((Main-a-1985) v-0)))))
(define Main-b-1962 (lambda () (lambda (v-0) (vector 109 (vector 116 (vector 3 ) (vector 100 ))))))
(define Main-c-1961 (lambda () (lambda (v-0) (vector 116 (vector 3 ) (vector 100 )))))
(define Main-a-1960 (lambda () (lambda (v-0) (((Main-t-1986) v-0) ((Main-a-1985) v-0)))))
(define Main-b-1958 (lambda () (lambda (v-0) (vector 116 (vector 3 ) (vector 100 )))))
(define Main-c-1957 (lambda () (lambda (v-0) (vector 116 (vector 3 ) (vector 116 (vector 100 ) (vector 100 ))))))
(define Main-a-1956 (lambda () (lambda (v-0) (((Main-t-1986) v-0) ((Main-a-1985) v-0)))))
(define Main-b-1947 (lambda () (lambda (v-0) (lambda (v-1) (lambda (v-2) (lambda (v-3) (lambda (v-4) (lambda (v-5) (vector 109 v-1)))))))))
(define Main-sa-1860 (lambda () (lambda (v-0) (lambda (v-1) (lambda (v-2) (lambda (v-3) (lambda (v-4) (lambda (v-5) (lambda (v-6) (lambda (v-7) (vector 105 (vector 3 ))))))))))))
(define Main-sa-1859 (lambda () (lambda (v-0) (lambda (v-1) (lambda (v-2) (lambda (v-3) (lambda (v-4) (lambda (v-5) (lambda (v-6) (lambda (v-7) (vector 104 (vector 3 ))))))))))))
(define Main-sa-1856 (lambda () (lambda (v-0) (lambda (v-1) (lambda (v-2) (lambda (v-3) (lambda (v-4) (lambda (v-5) (lambda (v-6) (lambda (v-7) (vector 116 (vector 104 (vector 3 )) (vector 105 (vector 3 )))))))))))))
(define Main-sa-1855 (lambda () (lambda (v-0) (lambda (v-1) (lambda (v-2) (lambda (v-3) (lambda (v-4) (lambda (v-5) (lambda (v-6) (lambda (v-7) (vector 110 (vector 3 ))))))))))))
(define Main-a-1841 (lambda () (lambda (v-0) (lambda (v-1) (lambda (v-2) (lambda (v-3) (lambda (v-4) (lambda (v-5) (lambda (v-6) (lambda (v-7) (lambda (v-8) (vector 116 v-4 (((((((((Main-b-1829) v-0) v-1) v-2) v-3) v-4) v-5) v-6) v-7)))))))))))))
(define Main-b-1829 (lambda () (lambda (v-0) (lambda (v-1) (lambda (v-2) (lambda (v-3) (lambda (v-4) (lambda (v-5) (lambda (v-6) (lambda (v-7) (vector 3 )))))))))))
(define Main-_-1828 (lambda () (lambda (v-0) (lambda (v-1) (lambda (v-2) (lambda (v-3) (lambda (v-4) (lambda (v-5) (lambda (v-6) (lambda (v-7) (vector 109 (vector 116 v-4 (((((((((Main-b-1829) v-0) v-1) v-2) v-3) v-4) v-5) v-6) v-7)))))))))))))
(define Main-b-1807 (lambda () (lambda (v-0) (lambda (v-1) (lambda (v-2) (vector 116 (vector 100 ) (vector 100 )))))))
(define Main-b-1794 (lambda () (lambda (v-0) (lambda (v-1) (lambda (v-2) (lambda (v-3) (vector 116 (vector 100 ) (vector 100 ))))))))
(define Main-b-1778 (lambda () (lambda (v-0) (lambda (v-1) (lambda (v-2) (lambda (v-3) (vector 116 (vector 100 ) (vector 100 ))))))))
(define Main-a-1761 (lambda () (lambda (v-0) (lambda (v-1) (lambda (v-2) (lambda (v-3) (vector 116 (vector 3 ) (vector 100 ))))))))
(define Main-a-1749 (lambda () (lambda (v-0) (lambda (v-1) (lambda (v-2) (lambda (v-3) (vector 116 (vector 3 ) (vector 100 ))))))))
(define Main-a-1728 (lambda () (lambda (v-0) (lambda (v-1) (lambda (v-2) (lambda (v-3) (vector 116 (vector 3 ) (vector 100 ))))))))
(define Main-a-1719 (lambda () (lambda (v-0) (lambda (v-1) (lambda (v-2) (lambda (v-3) (vector 116 (vector 3 ) (vector 100 ))))))))
(define Main-sa-1685 (lambda () (lambda (v-0) (vector 105 (vector 3 )))))
(define Main-sa-1684 (lambda () (lambda (v-0) (vector 104 (vector 3 )))))
(define Main-sa-1681 (lambda () (lambda (v-0) (vector 116 (vector 104 (vector 3 )) (vector 105 (vector 3 ))))))
(define Main-sa-1680 (lambda () (lambda (v-0) (vector 110 (vector 3 )))))
(define Main-ty-1640 (lambda () (lambda (v-0) (lambda (v-1) (lambda (v-2) (vector 109 (vector 109 (vector 100 ))))))))
(define Main-sa-1626 (lambda () (lambda (v-0) (lambda (v-1) (lambda (v-2) (vector 109 (vector 100 )))))))
(define Main-ty-1622 (lambda () (lambda (v-0) (lambda (v-1) (lambda (v-2) (vector 109 (vector 109 (vector 100 ))))))))
(define Main-a-1615 (lambda () (lambda (v-0) (lambda (v-1) (vector 109 (vector 109 (vector 100 )))))))
(define Main-b-1614 (lambda () (lambda (v-0) (lambda (v-1) (vector 109 (vector 109 (vector 100 )))))))
(define Main-a-1598 (lambda () (lambda (v-0) (vector 109 (vector 109 (vector 100 ))))))
(define Main-b-1597 (lambda () (lambda (v-0) (vector 109 (vector 109 (vector 100 ))))))
(define Main-a-1594 (lambda () (lambda (v-0) (vector 109 (vector 109 (vector 100 ))))))
(define Main-b-1593 (lambda () (lambda (v-0) (vector 109 (vector 109 (vector 100 ))))))
(define Main-b-1587 (lambda () (vector 109 (vector 109 (vector 100 )))))
(define Main-c-1586 (lambda () (vector 108 (Main-Grid))))
(define Main-a-1585 (lambda () (vector 109 (vector 109 (vector 100 )))))
(define Main-f-1581 (lambda () (lambda (v-0) (vector 108 v-0))))
(define Main-a-1580 (lambda () (vector 109 (vector 109 (vector 100 )))))
(define Main-b-1579 (lambda () (vector 109 (vector 109 (vector 100 )))))
(define Main-b-1578 (lambda () ((Main-f-1581) (Main-a-1580))))
(define Main-c-1577 (lambda () ((Main-f-1581) (Main-b-1579))))
(define Main-a-1576 (lambda () (vector 109 (vector 109 (vector 100 )))))
(define Main-a-1569 (lambda () (lambda (v-0) (lambda (v-1) (vector 109 (vector 100 ))))))
(define Main-a-1566 (lambda () (lambda (v-0) (lambda (v-1) (vector 109 (vector 100 ))))))
(define Main-b-1562 (lambda () (lambda (v-0) (lambda (v-1) (vector 109 (vector 109 (vector 100 )))))))
(define Main-c-1561 (lambda () (lambda (v-0) (lambda (v-1) (vector 109 (vector 109 (vector 100 )))))))
(define Main-a-1560 (lambda () (lambda (v-0) (lambda (v-1) (vector 109 (((Main-a-1566) v-0) v-1))))))
(define Main-a-1559 (lambda () (lambda (v-0) (lambda (v-1) (vector 109 (vector 100 ))))))
(define Main-a-1556 (lambda () (lambda (v-0) (lambda (v-1) (lambda (v-2) (vector 109 (vector 100 )))))))
(define Main-b-1552 (lambda () (lambda (v-0) (lambda (v-1) (lambda (v-2) (vector 109 (vector 109 (vector 100 ))))))))
(define Main-c-1551 (lambda () (lambda (v-0) (lambda (v-1) (lambda (v-2) (vector 109 (vector 100 )))))))
(define Main-a-1550 (lambda () (lambda (v-0) (lambda (v-1) (lambda (v-2) (vector 109 ((((Main-a-1556) v-0) v-1) v-2)))))))
(define Main-a-1549 (lambda () (lambda (v-0) (lambda (v-1) (lambda (v-2) (vector 109 (vector 100 )))))))
(define Main-a-1546 (lambda () (lambda (v-0) (lambda (v-1) (lambda (v-2) (vector 109 (vector 100 )))))))
(define Main-a-1545 (lambda () (lambda (v-0) (lambda (v-1) (lambda (v-2) (vector 109 (vector 100 )))))))
(define Main-a-1543 (lambda () (lambda (v-0) (lambda (v-1) (lambda (v-2) (vector 109 (vector 100 )))))))
(define Main-a-1533 (lambda () (lambda (v-0) (lambda (v-1) (vector 109 (vector 100 ))))))
(define Main-a-1528 (lambda () (lambda (v-0) (vector 109 (vector 100 )))))
(define Main-a-1517 (lambda () (vector 100 )))
(define Main-b-1513 (lambda () (vector 109 (vector 109 (vector 100 )))))
(define Main-c-1512 (lambda () (vector 108 (Main-Grid))))
(define Main-f-1507 (lambda () (lambda (v-0) (vector 108 v-0))))
(define Main-a-1506 (lambda () (vector 109 (vector 109 (vector 100 )))))
(define Main-b-1505 (lambda () (vector 109 (vector 109 (vector 100 )))))
(define Main-b-1504 (lambda () ((Main-f-1507) (Main-a-1506))))
(define Main-c-1503 (lambda () ((Main-f-1507) (Main-b-1505))))
(define Main-a-1502 (lambda () (vector 109 (vector 109 (Main-a-1517)))))
(define Main-a-1491 (lambda () (vector 109 (vector 100 ))))
(define Main-b-1490 (lambda () (vector 109 (vector 100 ))))
(define Main-b-1412 (lambda () (vector 109 (vector 3 ))))
(define Main-c-1411 (lambda () (vector 109 (vector 3 ))))
(define Main-acc-1408 (lambda () (vector 109 (vector 3 ))))
(define Main-f-1294 (lambda () (lambda (v-0) (vector 109 v-0))))
(define Main-b-1290 (lambda () (vector 109 (vector 5 ))))
(define Main-a-1288 (lambda () ((Main-f-1294) (vector 100 ))))
(define Main-f-1286 (lambda () (lambda (v-0) (vector 109 v-0))))
(define Main-a-1285 (lambda () (vector 109 (vector 100 ))))
(define Main-b-1282 (lambda () (vector 109 (vector 5 ))))
(define Main-a-1280 (lambda () ((Main-f-1286) (Main-a-1285))))
(define Main-b-1263 (lambda () (lambda (v-0) (vector 109 (vector 6 )))))
(define Main-t-1256 (lambda () (lambda (v-0) (lambda (v-1) (vector 109 v-1)))))
(define Main-a-1248 (lambda () (lambda (v-0) (((Main-t-1256) v-0) (vector 6 )))))
(define Main-b-1247 (lambda () (lambda (v-0) (((Main-t-1256) v-0) (vector 100 )))))
(define Main-b-1233 (lambda () (lambda (v-0) (lambda (v-1) (vector 100 )))))
(define Main-c-1232 (lambda () (lambda (v-0) (lambda (v-1) (vector 108 (((Main-b-1233) v-0) v-1))))))
(define Main-sa-1222 (lambda () (lambda (v-0) (vector 105 (vector 3 )))))
(define Main-sa-1221 (lambda () (lambda (v-0) (vector 104 (vector 3 )))))
(define Main-sa-1218 (lambda () (lambda (v-0) (vector 116 (vector 104 (vector 3 )) (vector 105 (vector 3 ))))))
(define Main-sa-1217 (lambda () (lambda (v-0) (vector 110 (vector 3 )))))
(define Main-ty-1204 (lambda () (lambda (v-0) (vector 109 (vector 109 (vector 100 ))))))
(define Main-a-1182 (lambda () (lambda (v-0) (lambda (v-1) (vector 109 (vector 6 ))))))
(define Main-a-1170 (lambda () (lambda (v-0) (lambda (v-1) (lambda (v-2) (vector 109 v-0))))))
(define Main-a-1167 (lambda () (lambda (v-0) (lambda (v-1) (vector 109 v-0)))))
(define Main-ty-665 (lambda () (lambda (v-0) (lambda (v-1) (vector 109 (vector 3 ))))))
(define Main-subGridsToRowsHelper (lambda (v-0 v-1) (let ((sc0 v-1)) (case (get-tag sc0) ((0) (let ((v-2 (vector-ref sc0 1))) (vector 0 4294)))(else (List-Prelude-C-43C-43 4294 (n--3258-1529-toRowHelper v-1 v-0 (List-Data-transpose 4294 (List-Data-take 4294 v-0 v-1))) (Main-subGridsToRowsHelper v-0 (List-Data-drop 4294 v-0 v-1))))))))
(define Main-subGridsToRows (lambda () (lambda (v-0) (Main-subGridsToRowsHelper (Prelude-fromInteger_Num__Nat 3) v-0))))
(define Main-solve (lambda (v-0) (Prelude-C-62C-62C-61_Monad__Maybe 4294 4294 ((Main-pruneGrid) v-0) (lambda (v-1) (n--4007-2283-solveC-39 v-0 v-1)))))
(define Main-showGrid (lambda () (lambda (v-0) ((Strings-Data-unlines) (Prelude-map_Functor__List 4294 4294 (lambda (v-1) ((Strings-Data-unwords) (Prelude-map_Functor__List 4294 4294 (lambda (v-2) (n--3015-1272-showCell v-2)) v-1))) v-0)))))
(define Main-readGrid (lambda (v-0) (Main-with--2933-1195 v-0 (Prelude-C-61C-61_Eq__Nat (Prelude-length v-0) (Prelude-fromInteger_Num__Nat 81)))))
...
(define Main-pruneGrid (lambda () (lambda (v-0) (n--3334-1609-fixM (lambda (v-1) (Main-pruneGridC-39 v-1)) v-0))))
...
(define Main-pruneCells (lambda (v-0) (Prelude-traverse_Traversable__List 4294 4294 4294 (vector 0 4294 (vector 0 4294 (lambda (v-1) (lambda (v-2) (lambda (v-3) (lambda (v-4) (Prelude-map_Functor__Maybe 4294 4294 v-3 v-4)))))) (lambda (v-1) (lambda (v-2) ((Prelude-pure_Applicative__Maybe 4294) v-2))) (lambda (v-1) (lambda (v-2) (lambda (v-3) (lambda (v-4) (Prelude-C-60C-42C-62_Applicative__Maybe 4294 4294 v-3 v-4)))))) (lambda (v-1) (n--3155-1421-pruneCell v-0 v-1)) v-0)))
(define Main-nextGrids (lambda (v-0) (Main-case--3373-2022 v-0 (n--3373-1656-fixCell v-0 (n--3373-1655-minimumPossible v-0 (List-Data-filter 4294 (lambda (v-1) (n--3373-1654-isPossible v-0 (Builtin-snd 4294 4294 v-1))) (((List-Data-zip 4294 4294) (Prelude-take 4294 (Prelude-fromInteger_Num__Nat 100) (Prelude-rangeFrom_Range__C-36a 4294 (vector 0 4294 4294 (vector 0 4294 (vector 0 4294 (lambda (v-1) (lambda (v-2) (((Prelude-C-43_Num__Int) v-1) v-2))) (lambda (v-1) (lambda (v-2) (((Prelude-C-42_Num__Int) v-1) v-2))) (lambda (v-1) ((Prelude-fromInteger_Num__Int) v-1))) (lambda (v-1) (lambda (v-2) (Prelude-div_Integral__Int v-1 v-2))) (lambda (v-1) (lambda (v-2) (Prelude-mod_Integral__Int v-1 v-2)))) (vector 0 4294 4294 (vector 0 4294 (vector 0 4294 (lambda (v-1) (lambda (v-2) (Prelude-C-61C-61_Eq__Int v-1 v-2))) (lambda (v-1) (lambda (v-2) (Prelude-C-47C-61_Eq__Int v-1 v-2)))) (lambda (v-1) (lambda (v-2) (Prelude-compare_Ord__Int v-1 v-2))) (lambda (v-1) (lambda (v-2) (Prelude-C-60_Ord__Int v-1 v-2))) (lambda (v-1) (lambda (v-2) (Prelude-C-62_Ord__Int v-1 v-2))) (lambda (v-1) (lambda (v-2) (Prelude-C-60C-61_Ord__Int v-1 v-2))) (lambda (v-1) (lambda (v-2) (Prelude-C-62C-61_Ord__Int v-1 v-2))) (lambda (v-1) (lambda (v-2) (Prelude-max_Ord__Int v-1 v-2))) (lambda (v-1) (lambda (v-2) (Prelude-min_Ord__Int v-1 v-2)))) (vector 0 4294 (vector 0 4294 (lambda (v-1) (lambda (v-2) (((Prelude-C-43_Num__Int) v-1) v-2))) (lambda (v-1) (lambda (v-2) (((Prelude-C-42_Num__Int) v-1) v-2))) (lambda (v-1) ((Prelude-fromInteger_Num__Int) v-1))) (lambda (v-1) (Prelude-negate_Neg__Int v-1)) (lambda (v-1) (lambda (v-2) (((Prelude-C-45_Neg__Int) v-1) v-2)))))) ((Prelude-fromInteger_Num__Int) 0)))) ((Prelude-concat 4294 4294 (vector 0 4294 4294 (vector 0 4294 (lambda (v-1) (lambda (v-2) (lambda (v-3) (lambda (v-4) (lambda (v-5) (Prelude-foldr_Foldable__List 4294 4294 v-3 v-4 v-5)))))) (lambda (v-1) (lambda (v-2) (lambda (v-3) (lambda (v-4) (lambda (v-5) (Prelude-foldl_Foldable__List 4294 4294 v-3 v-4 v-5))))))) (vector 0 4294 (vector 0 4294 (lambda (v-1) (lambda (v-2) (((Prelude-C-60C-43C-62_Semigroup__C-40ListC-32C-36aC-41 4294) v-1) v-2)))) (Prelude-neutral_Monoid__C-40ListC-32C-36aC-41 4294)))) v-0))))))))
(define Main-main (lambda () (Prelude-C-62C-62C-61_Monad__IO 4294 4294 (PrimIO-putStrLn "Please input the soduku:") (lambda (v-0) (Prelude-C-62C-62C-61_Monad__IO 4294 4294 (PrimIO-getLine) (lambda (v-1) (Main-case--4071-2359 v-0 v-1 (Main-readGrid v-1))))))))
(define Main-isGridInvalid (lambda (v-0) (Prelude-C-124C-124 ((Prelude-any 4294 4294 (vector 0 4294 (lambda (v-1) (lambda (v-2) (lambda (v-3) (lambda (v-4) (lambda (v-5) (Prelude-foldr_Foldable__List 4294 4294 v-3 v-4 v-5)))))) (lambda (v-1) (lambda (v-2) (lambda (v-3) (lambda (v-4) (lambda (v-5) (Prelude-foldl_Foldable__List 4294 4294 v-3 v-4 v-5))))))) (lambda (v-1) (n--3902-2180-isRowInvalid v-0 v-1))) v-0) (lambda () (Prelude-C-124C-124 ((Prelude-any 4294 4294 (vector 0 4294 (lambda (v-1) (lambda (v-2) (lambda (v-3) (lambda (v-4) (lambda (v-5) (Prelude-foldr_Foldable__List 4294 4294 v-3 v-4 v-5)))))) (lambda (v-1) (lambda (v-2) (lambda (v-3) (lambda (v-4) (lambda (v-5) (Prelude-foldl_Foldable__List 4294 4294 v-3 v-4 v-5))))))) (lambda (v-1) (n--3902-2180-isRowInvalid v-0 v-1))) (List-Data-transpose 4294 v-0)) (lambda () ((Prelude-any 4294 4294 (vector 0 4294 (lambda (v-1) (lambda (v-2) (lambda (v-3) (lambda (v-4) (lambda (v-5) (Prelude-foldr_Foldable__List 4294 4294 v-3 v-4 v-5)))))) (lambda (v-1) (lambda (v-2) (lambda (v-3) (lambda (v-4) (lambda (v-5) (Prelude-foldl_Foldable__List 4294 4294 v-3 v-4 v-5))))))) (lambda (v-1) (n--3902-2180-isRowInvalid v-0 v-1))) ((Main-subGridsToRows) v-0))))))))
(define Main-isGridFilled (lambda (v-0) ((Prelude-all 4294 4294 (vector 0 4294 (lambda (v-1) (lambda (v-2) (lambda (v-3) (lambda (v-4) (lambda (v-5) (Prelude-foldr_Foldable__List 4294 4294 v-3 v-4 v-5)))))) (lambda (v-1) (lambda (v-2) (lambda (v-3) (lambda (v-4) (lambda (v-5) (Prelude-foldl_Foldable__List 4294 4294 v-3 v-4 v-5))))))) (lambda (v-1) (n--3767-2045-isCellFilled v-0 v-1))) ((Prelude-concat 4294 4294 (vector 0 4294 4294 (vector 0 4294 (lambda (v-1) (lambda (v-2) (lambda (v-3) (lambda (v-4) (lambda (v-5) (Prelude-foldr_Foldable__List 4294 4294 v-3 v-4 v-5)))))) (lambda (v-1) (lambda (v-2) (lambda (v-3) (lambda (v-4) (lambda (v-5) (Prelude-foldl_Foldable__List 4294 4294 v-3 v-4 v-5))))))) (vector 0 4294 (vector 0 4294 (lambda (v-1) (lambda (v-2) (((Prelude-C-60C-43C-62_Semigroup__C-40ListC-32C-36aC-41 4294) v-1) v-2)))) (Prelude-neutral_Monoid__C-40ListC-32C-36aC-41 4294)))) v-0))))
(define Main-delete (lambda () (lambda (v-0) (lambda (v-1) (Prelude-foldl_Foldable__List 4294 4294 (lambda (v-2) (lambda (v-3) (Prelude-flip 4294 4294 4294 (lambda (v-4) (lambda (v-5) (n--3110-1373-deleteby v-4 v-5))) v-2 v-3))) v-0 v-1)))))
(define Main-chunksOfStr (lambda (v-0 v-1) (let ((sc0 v-1)) (cond ((equal? sc0 "") (vector 0 4294))(else (Prelude-map_Functor__List 4294 4294 (lambda (v-2) (Prelude-pack v-2)) (Main-chunksOf 4294 v-0 (Prelude-unpack v-1))))))))
(define Main-chunksOf (lambda (v-0 v-1 v-2) (let ((sc0 v-2)) (case (get-tag sc0) ((0) (let ((v-3 (vector-ref sc0 1))) (vector 0 4294)))(else (vector 1 4294 (List-Data-take 4294 v-1 v-2) (Main-chunksOf 4294 v-1 (List-Data-drop 4294 v-1 v-2))))))))
